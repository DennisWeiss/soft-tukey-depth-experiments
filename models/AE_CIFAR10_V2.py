...
class AE_CIFAR10_V2(nn.Module):
    def __init__(self):
        super(AE_CIFAR10_V2, self).__init__()
        ...
        self.encoding_layer = nn.Linear(32 * 5 * 5, 200)

        self.unflatten_layer = nn.Unflatten(dim=1, unflattened_size=(8, 5, 5))
        self.convT_layer1 = nn.ConvTranspose2d(in_channels=2, out_channels=32, kernel_size=(5, 5), padding=2)
        self.bn3 = nn.BatchNorm2d(32, eps=1e-4)
        self.convT_layer2 = nn.ConvTranspose2d(in_channels=32, out_channels=64, kernel_size=(5, 5), padding=4)
        self.bn4 = nn.BatchNorm2d(64, eps=1e-4)
        self.convT_layer3 = nn.ConvTranspose2d(in_channels=64, out_channels=3, kernel_size=(5, 5), padding=2)
