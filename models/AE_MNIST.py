...
class AE_MNIST(nn.Module):
    def __init__(self):
        ...
        self.encoding_layer = nn.Linear(4 * 4 * 4, 32)

        self.unflatten_layer = nn.Unflatten(dim=1, unflattened_size=(2, 4, 4))
        self.convT_layer1 = nn.ConvTranspose2d(in_channels=2, out_channels=4, kernel_size=(5, 5), padding=2)
